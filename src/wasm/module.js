...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5310720,
    DYNAMIC_BASE = 5310720,
    DYNAMICTOP_PTR = 67808;
...
var ASM_CONSTS = [function($0) { FS.mkdir('/node'); FS.mount(NODEFS, { root: UTF8ToString($0) }, '/node'); },
 function() { Module['runtimeInitialized'] = true; }];
...
// {{PRE_LIBRARY}}
  ...
  var _fetch_work_queue=67792;function __emscripten_get_fetch_work_queue() {
...
Module["asm"] = asm;
var _FetchNGram = Module["_FetchNGram"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_FetchNGram"].apply(null, arguments)
};

var _NGramScore = Module["_NGramScore"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_NGramScore"].apply(null, arguments)
};

var _ReadNGram = Module["_ReadNGram"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_ReadNGram"].apply(null, arguments)
};
